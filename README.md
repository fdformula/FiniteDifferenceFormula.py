...
This package is ported from https://github.com/Winux2k/FiniteDifferenceFormula.jl.

## This document needs modification .... because it is now for Julia.

This Python package provides a general finite difference formula generator and a tool
